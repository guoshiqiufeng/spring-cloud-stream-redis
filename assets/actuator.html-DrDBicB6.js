import{_ as t,c as e,b as n,d as a,e as o,f as l,a as c,r as u,o as i}from"./app-C5fYsfEg.js";const r={};function k(d,s){const p=u("RouteLink");return i(),e("div",null,[s[3]||(s[3]=n("h1",{id:"健康检查",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#健康检查"},[n("span",null,"健康检查")])],-1)),n("blockquote",null,[n("p",null,[s[1]||(s[1]=a("请确保您已经安装了 spring-cloud-stream-redis，如果您尚未安装，请查看 ")),o(p,{to:"/guide/install.html"},{default:l(()=>s[0]||(s[0]=[a("安装")])),_:1}),s[2]||(s[2]=a("。"))])]),s[4]||(s[4]=c(`<h2 id="开启配置" tabindex="-1"><a class="header-anchor" href="#开启配置"><span>开启配置</span></a></h2><div class="language-yaml" data-highlighter="prismjs" data-ext="yml" data-title="yml"><pre><code><span class="line"><span class="token key atrule">management</span><span class="token punctuation">:</span></span>
...
<span class="line"></span></code></pre></div><h2 id="访问路径" tabindex="-1"><a class="header-anchor" href="#访问路径"><span>访问路径</span></a></h2><p><code>/actuator/health</code></p><p>示例：</p><div class="language-json" data-highlighter="prismjs" data-ext="json" data-title="json"><pre><code><span class="line"><span class="token punctuation">{</span></span>
...
<span class="line">    <span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre></div>`,6))])}const h=t(r,[["render",k],["__file","actuator.html.vue"]]),m=JSON.parse('{"path":"/guide/actuator.html","title":"健康检查","lang":"zh-cn","frontmatter":{"lang":"zh-cn","title":"健康检查","description":null},"headers":[{"level":2,"title":"开启配置","slug":"开启配置","link":"#开启配置","children":[]},{"level":2,"title":"访问路径","slug":"访问路径","link":"#访问路径","children":[]}],"git":{"updatedTime":1731983255000,"contributors":[{"name":"yanghq","email":"1040926235@qq.com","commits":1,"url":"https://github.com/yanghq"}]},"filePathRelative":"guide/actuator.md"}');export{h as comp,m as data};
