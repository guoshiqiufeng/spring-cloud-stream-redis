import{_ as p,c as e,b as n,d as a,e as o,f as l,a as c,r as u,o as i}from"./app-C5fYsfEg.js";const r={};function k(d,s){const t=u("RouteLink");return i(),e("div",null,[s[3]||(s[3]=n("h1",{id:"actuator",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#actuator"},[n("span",null,"Actuator")])],-1)),n("blockquote",null,[n("p",null,[s[1]||(s[1]=a("ake sure you have spring-cloud-stream-redis installed，if you haven't, check out the ")),o(t,{to:"/en/guide/install.html"},{default:l(()=>s[0]||(s[0]=[a("Install")])),_:1}),s[2]||(s[2]=a("。"))])]),s[4]||(s[4]=c(`<h2 id="enable-configuration" tabindex="-1"><a class="header-anchor" href="#enable-configuration"><span>Enable configuration</span></a></h2><div class="language-yaml" data-highlighter="prismjs" data-ext="yml" data-title="yml"><pre><code><span class="line"><span class="token key atrule">management</span><span class="token punctuation">:</span></span>
...
<span class="line"></span></code></pre></div><h2 id="access-path" tabindex="-1"><a class="header-anchor" href="#access-path"><span>Access path</span></a></h2><p><code>/actuator/health</code></p><p>Example:</p><div class="language-json" data-highlighter="prismjs" data-ext="json" data-title="json"><pre><code><span class="line"><span class="token punctuation">{</span></span>
...
<span class="line">                        <span class="token property">&quot;version&quot;</span><span class="token operator">:</span> <span class="token string">&quot;7.1.2&quot;</span></span>
...
<span class="line">    <span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre></div>`,6))])}const q=p(r,[["render",k],["__file","actuator.html.vue"]]),g=JSON.parse('{"path":"/en/guide/actuator.html","title":"Actuator","lang":"en-US","frontmatter":{"lang":"en-US","title":"Actuator","description":"Actuator"},"headers":[{"level":2,"title":"Enable configuration","slug":"enable-configuration","link":"#enable-configuration","children":[]},{"level":2,"title":"Access path","slug":"access-path","link":"#access-path","children":[]}],"git":{"updatedTime":1731983255000,"contributors":[{"name":"yanghq","email":"1040926235@qq.com","commits":1,"url":"https://github.com/yanghq"}]},"filePathRelative":"en/guide/actuator.md"}');export{q as comp,g as data};
